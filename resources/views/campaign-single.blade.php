...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="gstore-breadcrumb position-relative z-1 overflow-hidden mt--50 tt-campaign-single-bg" style="background:
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-8">
                        <div class="breadcrumb-content">
                            <h2 class="mb-2 text-center text-light">Business Development Representative</h2>
                            <ul class="timing-countdown countdown-timer d-flex align-items-center gap-2 mt-3 justify-content-center" data-date="06/30/2023 23:59:59">
                ...
                <div class="row justify-content-center g-4 mt-5">
                    <div class="col-xxl-3 col-lg-4 col-md-6 col-sm-10">
                        <div class="vertical-product-card rounded-2 position-relative bg-white">
                            <div class="thumbnail position-relative text-center p-4">
                                <a href="{{ route('product-details') }}"><img src="assets/img/products/apple.png" alt="apple" class="img-fluid"></a>
                            ...
                            <div class="card-content">
                                <a href="{{ route('shop-grid') }}" class="mb-2 d-inline-block text-secondary fw-semibold fs-xxs">Fresh Organic</a>
                                <a href="{{ route('product-details') }}" class="card-title fw-bold d-block mb-2">Popped Rice Crisps Snacks Chocolate.</a>
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6 col-sm-10">
                        <div class="vertical-product-card rounded-2 position-relative bg-white">
                            ...
                            <div class="thumbnail position-relative text-center p-4">
                                <a href="{{ route('product-details') }}"><img src="assets/img/products/apple-black.png" alt="apple" class="img-fluid"></a>
                                <div class="product-btns position-absolute d-flex gap-2 flex-column">
                                    <a href="#" class="rounded-btn"><i class="fa-regular fa-heart"></i></a>
                                    <a href="#" class="rounded-btn">
                                        <svg width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6 col-sm-10">
                        <div class="vertical-product-card rounded-2 position-relative bg-white">
                            <div class="thumbnail position-relative text-center p-4">
                                <a href="{{ route('product-details') }}"><img src="assets/img/products/pinut.png" alt="apple" class="img-fluid"></a>
                                <div class="product-btns position-absolute d-flex gap-2 flex-column">
                                    <a href="#" class="rounded-btn"><i class="fa-regular fa-heart"></i></a>
                                    <a href="#" class="rounded-btn">
                                        <svg width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
