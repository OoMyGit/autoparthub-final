                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xxl-8 col-xl-9">
                            <ul class="d-flex align-items-center justify-content-center justify-content-xl-end topbar-info-right">
                                <li class="nav-item">
                                    <a href="mailto:autoparthub@gmail.com">
                                        <span class="me-1">
                                ...
                                <li class="nav-item dropdown tt-curency-dropdown">
                                    <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Login</a>
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item fs-xs" href="{{ route('login') }}">
                                                Login
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item fs-xs" href="{{ route('signup') }}">
                                                Sign Up
                                            </a>
                                        </li>
                                        <li>
                                ...
                                <nav class="gshop-navmenu ms-3 d-none d-xl-block">
                                    <ul class="d-flex align-itmes-center justify-content-end">
                                        <li class="has-submenu">
                                            <a href="javascript:void(0)">Dashboard<span class="ms-1 fs-xs float-end"><i
                                        ...
                                        <li class="has-submenu">
                                            <a href="javascript:void(0)">Products<span class="ms-1 fs-xs float-end"><i
                                                      class="fa-solid fa-angle-down"></i></span></a>
                                            <ul>
                                                <li><a href="{{ route('shop-grid-2') }}">Product List</a></li>
                                                <li><a href="{{ route('admin-edit-product') }}">Edit Products</a></li>
                                                <li><a href="{{ route('shop-grid-2') }}">Add Product</a></li>
                                            </ul>
                                        </li>
                                        <li class="has-submenu">
                                ...
                                <div class="gshop-header-icons d-none d-md-inline-flex align-items-center justify-content-end ms-3">
                                    <div class="gshop-header-user position-relative">
                                        ...
                                        <div class="user-menu-wrapper">
                                            <ul class="user-menu">
                                                <li><a href="{{ url('/my-account') }}"><span class="me-2"><i
                                ...
                                <div class="gshop-header-contact ms-7 position-relative d-none d-lg-flex d-xl-none d-xxl-flex">
                                    <a href="tel:+801570584567" class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <h6 class="mb-0 mt-1 fs-sm">+62 123 456 7890</h6>
                                        </div>
                                    </a>
                                </div>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="stat-box">
                    ...
                    <div class="stat-title">Revenue per Month</div>
            ...
            <div class="col-md-3">
                <div class="stat-box">
                    ...
                    <div class="stat-title">Product Sales</div>
                    <div class="stat-value">1500 units</div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="stat-box">
