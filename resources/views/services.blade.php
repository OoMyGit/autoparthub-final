...
<head>
    ...
    <!--title-->
    <title>Autoparthub - Services - Autoparthub Automotive eCommerce Website</title>
...
<body>
    ...
    <div class="main-wrapper">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xxl-8 col-xl-9">
                            <ul class="d-flex align-items-center justify-content-center justify-content-xl-end topbar-info-right">
                                <li class="nav-item">
                                    <a href="mailto:autoparthub@support.com">
                                        <span class="me-1">
                                ...
                                <li class="nav-item">
                                    ...
                                    Malang, East Java, Indonesia - 254230
                                </li>
                ...
                <div class="gshop-navbar bg-white rounded ps-lg-5 position-relative">
                    <div class="row align-items-center">
                        <div class="col-xxl-2 col-xl-3 col-md-3 col-5">
                            <a href="{{ route('index') }}" class="logo"><img src="assets/img/logo.png" alt="logo" class="img-fluid"></a>
                        </div>
                                ...
                                <div class="gshop-header-icons d-none d-md-inline-flex align-items-center justify-content-end ms-3">
                                    ...
                                    <div class="gshop-header-user position-relative">
                                        ...
                                        <div class="user-menu-wrapper">
                                            <ul class="user-menu">
                                                <li><a href="{{ route('my-account') }}"><span class="me-2"><i
                                                              class="fa-solid fa-user"></i></span>My Account</a></li>
                                                <li><a href="{{ route('cart') }}"><span class="me-2"><i
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb-content">
                            <h2 class="mb-2 text-center">Service Page</h2>
                            <nav>
                                <ol class="breadcrumb justify-content-center">
                                    ...
                                    <li class="breadcrumb-item fw-bold" aria-current="page">Services</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="service-section ptb-120 position-relative z-1 overflow-hidden">
                ...
                <div class="row g-4">
                    <div class="col-xl-6">
                        <div class="section-title text-center text-xl-start">
                            <h2 class="mb-0">We're Provide Natural & Premium Spareparts</h2>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="section-desc text-center text-xl-start">
                            <p class="mb-3">Holisticly coordinate client-based applications flexible supply chains. evolve principle-centered process improvements through cost effective information. leadership. Credibly whiteboard stand-alone.</p>
                            <a href="#" class="text-secondary fw-bold fs-xs">Loading...<span class="ms-2"><i class="fas fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
                <div class="row g-4 mt-5">
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="icon-box rounded-3 py-7 px-4">
                            ...
                            <a href="{{ route('service-details') }}" class="explore-btn fw-bold">Explore More<span class="ms-2"><i class="fas fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="icon-box rounded-3 py-7 px-4">
                            <div class="icon-wrapper mb-4 position-relative">
                                <img src="assets/img/icons/organic-color.svg" alt="icon" class="img-fluid icon-color">
                                <img src="assets/img/icons/organic-white.svg" alt="icon" class="img-fluid icon-white">
                            </div>
                            <a href="{{ route('service-details') }}">
        ...
        <section class="faq-section ptb-120 position-relative overflow-hidden z-1">
            <img src="assets/img/shapes/frame-circle.svg" alt="circle shape" class="position-absolute frame-circle z--1">
            <img src="assets/img/shapes/leaf.svg" alt="circle shape" class="position-absolute leaf z--1">
            <img src="assets/img/shapes/cauliflower.png" alt="cauliflower" class="position-absolute cauliflower z--1">
            <div class="container">
                <div class="row g-5">
                    <div class="col-xl-7">
                        <div class="feature-image p-3 text-center">
                            <img src="assets/img/about/girl.png" alt="girl" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-xl-5">
                        <div class="faq-right">
                            <h4 class="mb-4">We Care Your Family to Natural Products</h4>
                            <p class="mb-5">Holisticly coordinate client-based applications flexible supply chains. evolve leadership. Credibly whiteboard stand-alone.</p>
                            <div class="accordion faq-accordion" id="faq-accordion">
                                <div class="accordion-item">
                                    <div class="accordion-header">
                                        <a href="#acc-1" data-bs-toggle="collapse">Why Need Organic Foods For Life<i class="fas fa-angle-down float-end ms-1"></i></a>
                                    </div>
                                    <div class="accordion-collapse collapse show" id="acc-1" data-bs-parent="#faq-accordion">
                                        <div class="accordion-body">
                                            <p class="mb-0">Synergistically enable robust information before e-business leadership. Holisticly pursue worldwide methodologies without timely materials fabricate covalent internal.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <div class="accordion-header">
                                        <a href="#acc-2" data-bs-toggle="collapse" class="collapsed">Why Need Organic Foods For Life<i class="fas fa-angle-down float-end ms-1"></i></a>
                                    </div>
                                ...
                                <div class="accordion-item">
                                    <div class="accordion-header">
                                        <a href="#acc-3" data-bs-toggle="collapse" class="collapsed">Why Need Organic Foods For Life<i class="fas fa-angle-down float-end ms-1"></i></a>
                                    </div>
                                ...
                                <div class="accordion-item">
                                    <div class="accordion-header">
                                        <a href="#acc-4" data-bs-toggle="collapse" class="collapsed">Why Need Organic Foods For Life<i class="fas fa-angle-down float-end ms-1"></i></a>
                                    </div>
        ...
        <section class="feedback-section pb-120">
            <div class="container">
                    ...
                    <div class="row align-items-center g-3">
                        ...
                        <div class="col-lg-4 d-none d-lg-block">
                            <div class="logo-wrapper text-center">
                                <a href="{{ route('index') }}" class="logo"><img src="assets/img/logo-white.png" alt="logo" class="img-fluid"></a>
                            </div>
                        </div>
                        <div class="col-lg-4">
        ...
        <div class="mobile-toolbar d-block d-md-none d-lg-none">
            <div class="d-table table-layout-fixed w-100">
                ...
                <a class="d-table-cell mobile-toolbar-item" href="{{ route('my-account') }}">
                    <span class="mobile-toolbar-icon">
            <svg width="18" height="25" viewBox="0 0 22 25" fill="none"
                ...
                <a class="d-table-cell mobile-toolbar-item" href="{{ route('checkout') }}">
