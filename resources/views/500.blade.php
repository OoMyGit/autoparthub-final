...
<head>
    ...
    <!--title-->
    <title>Autoparthub - 404 - not found - Autoparthub Automotive eCommerce Website</title>
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-xl-6">
                        <div class="content-404 text-center">
                            <img src="assets/img/error-img.png" width="50%" alt="error 500" class="img-fluid mb-5 d-none d-md-inline-block">
