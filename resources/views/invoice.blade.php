...
<head>
    ...
    <!--title-->
    <title>Autoparthub - Invoice - Autoparthub Automotive eCommerce Website</title>
                    ...
                    <div class="row g-5 justify-content-between">
                        <div class="col-lg-6">
                            <div class="invoice-title d-flex align-items-center">
                                <h3>Invoice</h3>
                                <span class="badge rounded-pill bg-primary-light text-primary fw-medium ms-3">Delivered</span>
                            </div>
                        ...
                        <div class="col-lg-5 col-md-8">
                            <div class="text-lg-end">
                                ...
                                <h6 class="mb-0 text-gray mt-4">Cecilia Chapman, 711-2880 Nulla St, Mankato Mississippi 96522</h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-between g-5">
                        <div class="col-xl-8 col-lg-7">
                            <div class="welcome-message">
                                <h4 class="mb-2">Dear Fethawi Tesfalem</h4>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="shipping-address">
                                ...
                                <p class="mb-0">Unit 1/23 Hastings Road, Melbourne 3000, Victoria, Australia.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table invoice-table">
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    <img src="assets/img/products/cauliflower-xs.png" alt="product" class="img-fluid product-item">
                        ...
                        <table class="table footer-table">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="text-primary fw-bold">$580.00</span>
                                </td>
                            </tr>
                        </table>
                    </div>
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mt-7">
                        <a href="#" class="btn btn-primary btn-md">Pricing Invoice</a>
                        <a href="#" class="btn btn-primary-light btn-md">Download Invoice</a>
                    </div>
                </div>
            </div>
        </section> <!--invoice section end-->
