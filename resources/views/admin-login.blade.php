            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-5 col-12 bg-white d-flex p-0 tt-login-col shadow">
                        <form class="tt-login-form-wrap p-3 p-md-6 p-lg-6 py-7 w-100">
                            ...
                            <h2 class="mb-4 h3">Hey there! <br>Welcome back <span class="text-secondary">Autoparthub Admin Page.</span>
                            </h2>
                            <div class="row g-3">
                                <div class="col-sm-12">
               ...
               <i class="fa-solid fa-check"></i>
                            ...
                            <div class="row g-4 mt-4">
                                <div class="col-sm-6">
                                    <a href="{{ route('admin-dashboard') }}" class="btn btn-primary w-100">Sign In</a>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <p class="mb-0 fs-xs mt-4">Don't have an Admin Account? <a href="{{ route('admin-signup') }}">Sign Up</a>
                            </p>
                        </form>
                    </div>
                </div>
