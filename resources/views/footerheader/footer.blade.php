                    ...
                    <div class="row align-items-center g-3">
                        <div class="col-lg-4">
                            <div class="copyright-text">
                                <p class="mb-0 text-white">&copy; All rights reserved Made by <a href="#" class="text-secondary">Autoparthub</a></p>
                            </div>
                        </div>
        ...
        <div class="mobile-toolbar d-block d-md-none d-lg-none">
            <div class="d-table table-layout-fixed w-100">
                ...
                <a class="d-table-cell mobile-toolbar-item" href="{{ url('/my-account') }}">
                    <span class="mobile-toolbar-icon">
