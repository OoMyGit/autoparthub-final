                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb-content">
                            <h2 class="mb-2 text-center">All Coupons</h2>
                            <nav>
                                <ol class="breadcrumb justify-content-center">
                                    ...
                                    <li class="breadcrumb-item fw-bold" aria-current="page">coupons</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row g-4 justify-content-center">
                    <div class="col-lg-6 col-md-6">
                        <div class="card shadow-lg border-0 tt-coupon-single tt-gradient-top" style="background:
              url('assets/img/banner/banner-5.jpg')no-repeat center
              center / cover">
                            <div class="card-body text-center p-5">
                                <div class="offer-text mb-2 justify-content-center">
                                    <div class="up-to fw-bold text-light">UP TO</div>
                                    <div class="display-4 fw-bold text-danger">75</div>
                                    <p class="mb-0 fw-bold text-danger"><span>%</span> <br> Off</p>
                                </div>
                                <div class="coupon-row">
                                    <span class="copyCode">GTSMAR23</span>
                                    <span class="copyBtn">Copy Code</span>
                                </div>
                                <h5 class="text-light">Valid Till:</h5>
                                <ul class="timing-countdown countdown-timer d-inline-block gap-2 mt-3" data-date="06/30/2023 23:59:59">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="card shadow-lg border-0 tt-coupon-single tt-gradient-top" style="background:
              url('assets/img/banner/banner-2.jpg')no-repeat center
              center / cover">
                            <div class="card-body text-center p-5">
                                <div class="offer-text mb-2 justify-content-center">
                                    <div class="up-to fw-bold text-light">UP TO</div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="card shadow-lg border-0 tt-coupon-single tt-gradient-top" style="background:
              url('assets/img/banner/banner-1.jpg')no-repeat center
              center / cover">
                            <div class="card-body text-center p-5">
                                <div class="offer-text mb-2 justify-content-center">
                                    <div class="up-to fw-bold text-light">UP TO</div>
                                ...
                                <div class="coupon-row">
                                    <span class="copyCode">GTSMAR24</span>
                                    <span class="copyBtn">Copy Code</span>
                                </div>
                                <h5 class="text-light">Valid Till:</h5>
                                <ul class="timing-countdown countdown-timer d-inline-block gap-2 mt-3" data-date="06/30/2023 23:59:59">
